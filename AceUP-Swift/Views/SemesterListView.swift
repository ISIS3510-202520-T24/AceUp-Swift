...
struct SemesterListView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showCreateSheet) {
            CreateSemesterSheet(viewModel: viewModel, isPresented: $showCreateSheet)
        }
        .sheet(isPresented: $showEditSheet) {
            EditSemesterSheet(viewModel: viewModel, isPresented: $showEditSheet)
        }
    ...
    private var emptyStateView: some View {
        VStack(spacing: 20) {
            ...
            Text("Create your first semester to organize your courses by academic period")
                .font(.body)
                .foregroundColor(Color(hex: "#8B8680"))
