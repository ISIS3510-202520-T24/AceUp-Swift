...
class WeekViewSyncService: ObservableObject {
    ...
    nonisolated private var currentUserId: String {
            ...
            persistenceController.persistentContainer.performBackgroundTask { context in
                do {
                    ...
                    for assignment in assignments {
                        ...
                        let cacheRequest = NSFetchRequest<WeekEventEntity>(entityName: "WeekEventEntity")
                    ...
                    continuation.resume(returning: .success("Synced \(assignments.count) assignments to cache"))
        ...
        return await withCheckedContinuation { continuation in
            persistenceController.persistentContainer.performBackgroundTask { context in
                do {
                    ...
                    continuation.resume(returning: .success("Synced \(events.count) external calendar events"))
